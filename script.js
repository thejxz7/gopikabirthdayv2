...
let moonPressActive=false;

function startMoonPress(e){

    moonPressActive=true;

    moonPressTimer=setTimeout(()=>{

        if(!moonPressActive) return;
...
function cancelMoonPress(){
    ...
    moonPressActive=false;

    clearTimeout(moonPressTimer);

}

moonEl.style.touchAction="none";

moonEl.addEventListener("pointerdown",startMoonPress);
moonEl.addEventListener("pointerup",cancelMoonPress);
moonEl.addEventListener("pointerleave",cancelMoonPress);
moonEl.addEventListener("pointercancel",cancelMoonPress);
